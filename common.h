...
// the total latency will be limited to the min and max-latency values, if supplied
  ...
  double
      lead_in_silence_initial_period; // the size of the first block of silence to send to the DAC
  int lead_in_silence_minimum_adjustments_to_make; // make at least this number of checks  and
                                                   // timing adjustments
